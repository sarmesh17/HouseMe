...
@Composable
fun SignInScreen(
    signinScreen: SiginScreenViewModel,
    ...
    val result by signinScreen.loginResult.collectAsState()
    ...
    when(result){
        ...
        is Result.Error -> {
            ...
            (result as Result.Error<String>).message?.let { Log.d("SigInError", it) }
        }
            ...
            Column(
                ...
                Box(
                    modifier = Modifier
                        ...
                        .clickable {
                            coroutine.launch {
                                signinScreen.loginUser(email, password);
