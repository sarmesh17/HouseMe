package com.sharkdroid.houseme.presentation.bookinghistory
...
@Composable
fun BookingHistory(navController: NavHostController,) {
    ...
    Scaffold(
        ...
        bottomBar = {
            ...
            BottomNavigation(selectedItem = 3, onClick = { index ->
                when (index) {
